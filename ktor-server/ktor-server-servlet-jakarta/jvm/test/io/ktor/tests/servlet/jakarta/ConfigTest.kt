...
import io.ktor.server.servlet.jakarta.ServletApplicationEngine.Companion.EmbeddedServerAttributeKey
import io.mockk.*
...
class ConfigTest {
    ...
    fun resolveParametersFromCustomConfig() {
        ...
        val context = mockk<ServletContext> {
            ...
            every { getAttribute(EmbeddedServerAttributeKey) } returns null
        }
